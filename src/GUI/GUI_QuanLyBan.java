...
public class GUI_QuanLyBan extends JPanel {
	...
	public GUI_QuanLyBan() {
		...
		JButton btnCapNhat = new JButton("CẬP NHẬT",
				new ImageIcon(getClass().getResource("/view/icon/icon_capnhat.png")));
		...
		// Lắng nghe sự thay đổi ngày: mỗi khi người dùng chọn ngày mới, cập nhật lại
		// danh sách bàn
	...
	private void updateGridPanel(Date selectedDate) {
		...
		// Lấy dữ liệu bàn thông qua DAO, ví dụ sử dụng phương thức getAllBanByDate(Date
		// date)
		...
		for (Ban ban : listBan) {
			...
			final ImageIcon selectedIcon = new ImageIcon(new ImageIcon(getClass().getResource(selectedIconPath))
					.getImage().getScaledInstance(100, 100, Image.SCALE_SMOOTH));

			// Tạo panel cho mỗi bàn với kích thước cố định 300 x 150, sử dụng Border bo
			// tròn
