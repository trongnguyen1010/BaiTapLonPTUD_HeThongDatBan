...
public class GUI_TimKiemKhachHang extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jPanel1Layout.setHorizontalGroup(jPanel1Layout.createParallelGroup(Alignment.TRAILING)
				.addGroup(jPanel1Layout.createSequentialGroup().addGap(42).addComponent(jButton1).addGap(37)
						...
						.addGap(41).addComponent(txtTimKiem, GroupLayout.PREFERRED_SIZE, GroupLayout.DEFAULT_SIZE,
	...
	public void hienThiKetQuaTimKiem(List<KhachHang> ketQua) {
		...
		for (KhachHang kh : ketQua) {
			model.addRow(new Object[] { stt++, kh.getMaKhachHang(), kh.getTenKhachHang(), kh.getSdt(), kh.getEmail(),
					kh.getGioiTinh() });
		}
	}
