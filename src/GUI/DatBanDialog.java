...
public class DatBanDialog extends JDialog {
    ...
    private void initComponents() {
        ...
        String bookingStr = String.format("Ngày đặt: %s   Giờ: %s - %s", 
                                sdf.format(bookingDate), startTime, endTime);
        ...
        contentPanel.setBorder(new TitledBorder(new LineBorder(Color.GRAY, 1), 
                "Nhập thông tin khách hàng", TitledBorder.LEADING, TitledBorder.TOP,
