...
public class FrmCapnhatNhanVien extends JPanel {
    ...
    public static void main(String[] args) {
        EventQueue.invokeLater(() -> {
            try {
                ...
                FrmCapnhatNhanVien panel = new FrmCapnhatNhanVien();
    ...
    public FrmCapnhatNhanVien() {
        ...
        lblNewLabel_2.setIcon(new ImageIcon(FrmCapnhatNhanVien.class.getResource("/view/image/filenv.png")));
...
//        add(btnThmNhnVin);
     ...
     ImageIcon originalIcon = new ImageIcon(FrmCapnhatNhanVien.class.getResource("/view/icon/icon_them.png"));
     ...
     // Lấy icon gốc và thay đổi kích thước
     ImageIcon originalIcon_1 = new ImageIcon(FrmCapnhatNhanVien.class.getResource("/view/icon/icon_capnhat.png"));
