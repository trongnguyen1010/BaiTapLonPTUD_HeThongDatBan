...
public class GUI_homepage extends JFrame {
	...
	private void addButtonEffects(JButton button, Color hoverColor, Font hoverFont, Color defaultColor,
			Font defaultFont, Color activeColor) {
	}
...
//        menu_nav.setLayout(new FlowLayout(FlowLayout.LEFT));
		...
		subMenuItems.put("Tài Khoản",
				new String[] { "Quản lý tài khoản", "Tìm kiếm tài khoản", "Đổi mật khẩu", "Đăng xuất" });
