...
public class GUI_FrmDangNhap extends JFrame {
	...
	public GUI_FrmDangNhap() {
		...
		JLabel lbltenDN = createLabel("Đăng Nhập", 179, 72, 142, 54, new Font("Times New Roman", Font.BOLD, 24),
				Color.WHITE);
		panel.add(lbltenDN);
		...
		panel.add(createLabel("Quên mật Khẩu?", 143, 259, 85, 13, new Font("Times New Roman", Font.PLAIN, 10),
				Color.WHITE));
	...
	private void dangNhap() {
		...
		if (tenDangNhap.isEmpty() || matKhau.isEmpty()) {
			JOptionPane.showMessageDialog(this, "Vui lòng nhập tài khoản và mật khẩu!", "Lỗi",
