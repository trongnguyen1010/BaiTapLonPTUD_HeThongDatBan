...
public class GUI_QuanLyKhachHang extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jComboBox1.setModel(
				new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã khách hàng", "Họ tên", "Số điện thoại" }));
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String[] { "STT", "Mã khách hàng", "Họ tên", "Email", "Số điện thoại", "Giới tính" }));
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		int confirm = javax.swing.JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa khách hàng này?",
				"Xác nhận xóa", javax.swing.JOptionPane.YES_NO_OPTION, javax.swing.JOptionPane.QUESTION_MESSAGE);
	...
	private void txtTimKiemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		for (KhachHang kh : customers) {
			model.addRow(new Object[] { stt++, kh.getMaKhachHang(), kh.getTenKhachHang(), kh.getEmail(), kh.getSdt(),
					kh.getGioiTinh() });
		}
	}
