...
public class GUI_QuanLyTaiKhoan extends javax.swing.JPanel {
	...
	private void initComponents() {
		...
		jComboBox1.setModel(
				new javax.swing.DefaultComboBoxModel<>(new String[] { "Mã tài khoản", "Tên đăng nhập", "Chủ sở hữu" }));
		...
		jTable1.setModel(new javax.swing.table.DefaultTableModel(
				...
				new String[] { "STT", "Mã tài khoản", "Tên đăng nhập", "Mật khẩu", "Chủ sở hữu", "Chức vụ" }));
	...
	private void jButton4ActionPerformed(java.awt.event.ActionEvent evt) {
		...
		if (selectedRow != -1) {
			String maTaiKhoan = jTable1.getValueAt(selectedRow, 1).toString();
			int confirm = javax.swing.JOptionPane.showConfirmDialog(this, "Bạn có chắc chắn muốn xóa tài khoản này?",
	...
	private void txtTimKiemActionPerformed(java.awt.event.ActionEvent evt) {
		...
		for (TaiKhoan tk : taiKhoans) {
			model.addRow(new Object[] { stt++, tk.getMaTaiKhoan(), tk.getTenDangNhap(), tk.getMatKhau(),
					tk.getNhanVien().getTen(), tk.getNhanVien().getChucVu() });
		}
	}
