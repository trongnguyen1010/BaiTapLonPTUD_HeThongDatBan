...
//
    	...
    	// ===== Các dòng thông tin =====
    	jPanel17.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 8, 8));
    	jLabel10.setText("Mã Món Ăn:");
    	jLabel10.setPreferredSize(new java.awt.Dimension(100, 40));
    	txtMaThuoc.setEditable(false);
    	txtMaThuoc.setFocusable(false);
    	txtMaThuoc.setPreferredSize(new java.awt.Dimension(200, 40));
    	jPanel17.add(jLabel10);
    	jPanel17.add(txtMaThuoc);

    	jPanel18.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 8, 8));
    	...
    	jPanel21.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 8, 8));
    	...
    	txtDonGia.setPreferredSize(new java.awt.Dimension(150, 40));
    	...
    	// Thêm phần text info vào trung tâm
    	...
    	// Thiết lập thuộc tính cho ô hiển thị Đơn giá
    	txtDonGia.setEditable(false); // Không cho chỉnh sửa
    	txtDonGia.setFont(new java.awt.Font("Roboto Mono Medium", 0, 14)); // Font chữ
    	txtDonGia.setText("123123"); // Giá trị mẫu (test)
    	txtDonGia.setFocusable(false); // Không cho lấy focus khi tab
    	txtDonGia.setPreferredSize(new java.awt.Dimension(120, 40)); // Kích thước ô nhập
    	jPanel21.add(txtDonGia); // Thêm txtDonGia vào jPanel21

    	// ======================= Thiết lập layout cho jPanel24 =======================
    	javax.swing.GroupLayout jPanel24Layout = new javax.swing.GroupLayout(jPanel24);
    	jPanel24.setLayout(jPanel24Layout);

    	// ==== Layout ngang: chia các panel theo chiều ngang (từ trái qua phải)
    	jPanel24Layout.setHorizontalGroup(
    	    jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    	    .addGroup(jPanel24Layout.createSequentialGroup()
    	        .addContainerGap() // padding trái
    	        .addComponent(jPanel21, javax.swing.GroupLayout.PREFERRED_SIZE, 263, javax.swing.GroupLayout.PREFERRED_SIZE) // panel chứa đơn giá
    	        .addContainerGap(612, Short.MAX_VALUE)) // khoảng trống bên phải
    	    // Nhóm layout song song khác (nằm trong nhóm chính)
    	    .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    	        .addGroup(jPanel24Layout.createSequentialGroup()
    	            .addContainerGap()
    	            .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    	                .addComponent(jPanel18, javax.swing.GroupLayout.DEFAULT_SIZE, 869, Short.MAX_VALUE) // Tên món ăn
    	                .addComponent(jPanel17, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE) // Mã món ăn
    	                .addComponent(jPanel19, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)) // Các thông tin khác (nếu có)
    	            .addContainerGap()))
    	);

    	// ==== Layout dọc: chia theo chiều dọc (trên xuống dưới)
    	jPanel24Layout.setVerticalGroup(
    	    jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    	    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, jPanel24Layout.createSequentialGroup()
    	        .addContainerGap(205, Short.MAX_VALUE) // đẩy xuống thấp
    	        .addComponent(jPanel21, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE) // Đơn giá
    	        .addGap(21, 21, 21)) // khoảng cách dưới cùng
    	    // Nhóm layout dọc thứ 2: các dòng thông tin trên
    	    .addGroup(jPanel24Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
    	        .addGroup(jPanel24Layout.createSequentialGroup()
    	            .addContainerGap()
    	            .addComponent(jPanel17, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE) // Mã món
    	            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    	            .addComponent(jPanel18, javax.swing.GroupLayout.PREFERRED_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.PREFERRED_SIZE) // Tên món
    	            .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
    	            .addComponent(jPanel19, javax.swing.GroupLayout.PREFERRED_SIZE, 102, javax.swing.GroupLayout.PREFERRED_SIZE) // thông tin khác
    	            .addContainerGap(66, Short.MAX_VALUE))) // padding dưới
    	);

    	// Thêm jPanel24 vào jPanel16 (trung tâm)
    	jPanel16.add(jPanel24, java.awt.BorderLayout.CENTER);

    	// Thêm jPanel16 vào sanPhamPanel (vùng trung tâm toàn phần)
    	sanPhamPanel.add(jPanel16, java.awt.BorderLayout.CENTER);

    	// Thêm sanPhamPanel vào mainPanel, đặt ở vị trí PAGE_START (trên cùng)
    	mainPanel.add(sanPhamPanel, java.awt.BorderLayout.PAGE_START);

    	// ======================= Panel bên dưới: giỏ hàng và thanh công cụ =======================
    	...
    	// ==== Action panel chứa thanh công cụ tìm kiếm, lọc,...
    	...
    	// Panel chứa các thành phần tìm kiếm (cbox + ô tìm)
    	jPanel12.setBackground(new java.awt.Color(255, 255, 255));
    	jPanel12.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 8)); // căn trái

    	// Một panel phụ bên trong (có thể dùng cho filter)
    	jPanel14.setBackground(new java.awt.Color(255, 255, 255));
    	jPanel14.setLayout(new java.awt.FlowLayout(java.awt.FlowLayout.LEFT, 5, 0));
    	jPanel12.add(jPanel14); // thêm vào jPanel12
    	...
    	txtSearch.addKeyListener(new java.awt.event.KeyAdapter() {
    	    public void keyReleased(java.awt.event.KeyEvent evt) {
    	       // txtSearchKeyReleased(evt); // hàm xử lý tìm kiếm khi gõ phím
    	    }
    	});
        ...
        btnReload.setIcon(new ImageIcon("src/view/icon_them"));
