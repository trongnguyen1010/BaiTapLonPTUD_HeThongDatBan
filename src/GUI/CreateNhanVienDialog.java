...
public class CreateNhanVienDialog extends javax.swing.JDialog {
	...
	public CreateNhanVienDialog(java.awt.Frame parent, boolean modal, GUI_QuanLyNhanVien NV_GUI) {
		super(parent, modal);
		initComponents();
		this.NV_GUI = NV_GUI;
	}
	...
	private void initComponents() {
		...
		lblDialog.setText("THÊM NHÂN VIÊN");
		...
		cboxChucVu = new javax.swing.JComboBox<>();
		cboxChucVu.setModel(new javax.swing.DefaultComboBoxModel<>(
