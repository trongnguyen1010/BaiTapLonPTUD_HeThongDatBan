...
public class CreateHoaDonMADialog extends JDialog {
    ...
    private void loadMonAnTuDB() {
        ...
        for (MonAn mon : danhSachMonAn) {
            ...
            // Tên + giá
            JLabel lblInfo = new JLabel("<html><center>" + mon.getTenMonAn() + "<br>Giá: " + mon.getDonGia() + "</center></html>", SwingConstants.CENTER);
    ...
    private void themMonAnVaoHoaDon(MonAn mon, int quantity) {
        ...
        MonAn monWithQuantity = new MonAn(mon.getMaMonAn(), mon.getTenMonAn(), mon.getDonGia(), quantity, null);
